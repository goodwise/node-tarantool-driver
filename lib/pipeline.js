...
function exec () {
    ...
    return new Promise(function (resolve) {
        ...
        .then(function (result) {
            makePipelineResponse(result)
            resolve(result)
        })
    })
}

function makePipelineResponse (array) {
	array.__proto__.findPipelineError = findPipelineError;
	array.__proto__.findPipelineErrors = findPipelineErrors;
}
