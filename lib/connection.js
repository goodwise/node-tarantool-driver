    ...
    switch (this.state){
        ...
        case states.CONNECT:
            if(!this.socket || !this.socket.writable){
                ...
                if ((this.options.nonWritableHostPolicy === 'changeAndRetry') || tupleToObject) setValue[2] = Object.values(commandArguments);
...
function connect (){
    return new Promise(function (resolve, reject) {
        if (this.state === states.CONNECTING || this.state === states.CONNECT || this.state === states.CONNECTED || this.state === states.AUTH) {
